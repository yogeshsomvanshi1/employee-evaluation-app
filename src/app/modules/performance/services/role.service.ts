...
export class RoleService {
  ...
  getRoleContentColumes3(param: HttpParams){
    ...
    return this.httpClient.get("http://192.168.1.11:9999/core/role/", options);
  }
  ...
  getAll(
    param: HttpParams
  ): Observable<{ content: Array<Role>; totalPages: number }> {
    const options = {
      params: param,
    };
    ...
    return this.httpClient.get<{
      content: Array<Role>;
      totalPages: number;
    }>(`${environment.performance}core/role/`, options);
  }
